...
public class NetTool {
    ...
    private int j = 0;//存放ip最后一位地址 0-255
     ...
     * 扫描局域网内ip，找到对应服务器
     */
    public void scan(final List<String> listIp){

        locAddress = getLocAddrIndex();//获取本地ip前缀
        Log.i("NetTool","locAddress:"+locAddress);
        ...
        for ( int i = 0; i < 260; i++) {//创建256个线程分别去ping
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    Log.i("NetTool","current_ip:"+current_ip);
